        ...
        bingoGameApp.controller('bingoGameController', function($scope, $timeout, ngDialog) {
            ...
            $scope.questions = [
                ...
                {text: 'Never speak on behalf of the Cooperative’s brands on ____________-produced content, industry-shared resources or online forums, groups and chat boards unless authorized to do so.', answerId: 26},
